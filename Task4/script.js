...
function setUpStartCards(){
    cards = [
        {
            name: 'M5',
            url: 'https://img.razrisyika.ru/kart/11/1200/41475-bmv-m5-2.jpg',
            id: 0,
            disc: 'Моя малышка',
            provider: 'ОАО БМВ констр.'
        },
        {
            name: 'ешка 63',
            url: 'https://ag-spots-2015.o.auroraobjects.eu/2015/11/17/mercedes-benz-c-63-amg-coupe-black-series-c207517112015153212_1.jpg',
            id: 1,
            disc: 'Статус невероятный',
            provider: 'ЗЗЗ Мерседес'
        },
        {
            name: 'РЫкса седьмая',
            url: 'https://i.playground.ru/p/Con9PjuPx8qfa4ZrCxtoOQ.jpeg',
            id: 2,
            disc: 'неповторимый ротор',
            provider: 'Маздочка'
        }
    ];
    globalCards = cards;
